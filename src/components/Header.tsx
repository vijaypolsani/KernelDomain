  ...
  return (
    <div className='bg-bodyColor h-20 top-0 sticky z-50'>
      <Container className='h-full flex  items-center md:gap-x-5  md:justify-start'>
        ...
        {/* Search Field */}
        <div className='w-full bg-white hidden md:flex items-center gap-x-1 border-[1px] border-lightText/50 rounded-full px-2 py-1 focus-within:border-orange-600 group'>
