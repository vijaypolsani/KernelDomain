    ...
    <Container className='flex items-center justify-center py-20'>
      <div className='min-h-[200px] flex flex-col items-center justify-center gap-y-5'>
        ...
        <div className='grid grid-cols-2 gap-4 place-content-evenly hover:place-content-center font-bold px-8 line-clamp-2 h-60 ...'>
          ...
          <div>
            Cloud digital transformation, load migration, application
            modernization with integrated Machine Learning Model powered actions
          </div>
          <div>
            Building efficient systems for FinTech, MarTech, & InsureTech
            domains
          </div>
